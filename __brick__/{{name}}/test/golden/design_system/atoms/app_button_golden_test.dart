...
import 'package:{{name}}/design_system/atoms/app_button.dart';
  ...
  group('AppButton golden tests', () {
    ...
    testWidgets('primary variant light', (tester) async {
      ...
      await tester.expectGoldenFile(
        ...
        'goldens/app_button_primary_light.png',
      );
    });
    ...
    testWidgets('primary variant dark', (tester) async {
      ...
      await tester.expectGoldenFile(
        find.byType(AppButton),
        'goldens/app_button_primary_dark.png',
      );
    });
    ...
    testWidgets('secondary variant', (tester) async {
      ...
      await tester.expectGoldenFile(
        find.byType(AppButton),
        'goldens/app_button_secondary.png',
      );
    });
    ...
    testWidgets('outline variant', (tester) async {
      ...
      await tester.expectGoldenFile(
        find.byType(AppButton),
        'goldens/app_button_outline.png',
      );
    });
    ...
    testWidgets('disabled state', (tester) async {
      ...
      await tester.expectGoldenFile(
        find.byType(AppButton),
        'goldens/app_button_disabled.png',
      );
    });
    ...
    testWidgets('loading state', (tester) async {
      ...
      await tester.expectGoldenFile(
        find.byType(AppButton),
        'goldens/app_button_loading.png',
      );
    });
  });
}
