...
import '../../../../lib/design_system/atoms/app_text_field.dart';
  ...
  group('AppTextField golden tests', () {
    testWidgets('outlined variant', (tester) async {
      ...
      await expectLater(
        ...
        matchesGoldenFile('goldens/app_text_field_outlined.png'),
      );
    });
    ...
    testWidgets('filled variant', (tester) async {
      ...
      await expectLater(
        find.byType(AppTextField),
        matchesGoldenFile('goldens/app_text_field_filled.png'),
      );
    });
    ...
    testWidgets('with icons', (tester) async {
      ...
      await expectLater(
        find.byType(AppTextField),
        matchesGoldenFile('goldens/app_text_field_icons.png'),
      );
    });
  });
}
